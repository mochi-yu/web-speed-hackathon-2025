...
const SeekThumbnail = lazy(() => import('@wsh-2025/client/src/pages/episode/components/SeekThumbnail'));
          ...
          <div className="flex flex-row items-center">
            <div className="flex flex-row items-center">
              <Hoverable classNames={{ default: 'bg-transparent', hovered: 'bg-[#FFFFFF1F]' }}>
                ...
                >
                  <span
                    className={`i-custom-symbols:${playing ? 'pause-rounded' : 'play-arrow-rounded'} m-[14px] block size-[20px] shrink-0 grow-0 text-[#FFFFFF]`}
                  />
                </button>
              </Hoverable>
